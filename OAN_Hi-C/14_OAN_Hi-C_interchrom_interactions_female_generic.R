...
#Read data
hic <- read.delim(paste0("data/Female_matrix_", binsize, "_bin_normalised_corrected_-2_3.tsv"), header = FALSE)
...
#Save plot
ggsave(paste0("plots/Platypus_Female_", binsize, "_navyblueorange_lims_", lim1, "_", lim2, "_zerowindows.pdf"), plot = plot, width = 10, height = 8, units = "in", dpi = 800)

#Save longData
write.table(longData, file = paste0("data/longDatafemale_", binsize, "_zerowindows.txt"), quote = FALSE, sep = "\t", row.names = FALSE)

#Save hic
fwrite(merged_data, file = paste0("data/hicfemale_", binsize, "_zerowindows.txt"), quote = FALSE, sep = "\t")
